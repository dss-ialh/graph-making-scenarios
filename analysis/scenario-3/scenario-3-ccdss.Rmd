...
This document narrates the demonstration of the `(prep + plot + print) + place` technique using the data from Canadian Chronic Disease Surveillance System (CCDSS).
...
## graph-2 wrap
```{r phase-1-graph-2, echo=echo_chunks, results='show', message=message_chunks,fig.width=11, fig.height=7, out.width="960px", warning = FALSE}
```

## graph-2 grid

```{r phase-1-graph-3, echo=echo_chunks, results='show', message=message_chunks,fig.width=11, fig.height=7, out.width="960px", warning = FALSE}
```

```{r phase-1-graph-4, echo=echo_chunks, results='show', message=message_chunks,fig.width=11, fig.height=16, out.width="960px", warning = FALSE}
```
...
```{r phase-2-make_plot-2, echo=echo_chunks, results='show', message=message_chunks,fig.width=11, fig.height=7,out.width="960px"}
```
...
```{r phase-4-print_plot-2, echo=echo_chunks, results="asis", message=message_chunks,out.width="960px"}
```
