...
We will proceed building a reproducible graphing system in the following sequence of phases:
...
read_chunk("./analysis/scenario-3/scenario-3-ccdss-00-applications.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
# set the scene
...
```{r phase-6-place_plot, echo=echo_chunks, results='show', message=message_chunks,out.width="960px",warning=warning_chunks}
